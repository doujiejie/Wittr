...
},{"matches-selector":43}],2:[function(require,module,exports){
'use strict';
...
},{"../object/keys":39}],16:[function(require,module,exports){
...
},{"../object/keys":39,"./baseCopy":17}],17:[function(require,module,exports){
/**
...
},{"../utility/identity":42}],21:[function(require,module,exports){
...
},{"../function/restParam":12,"./bindCallback":20,"./isIterateeCall":27}],22:[function(require,module,exports){
...
},{"../function/restParam":12}],23:[function(require,module,exports){
...
},{"./baseProperty":18}],24:[function(require,module,exports){
...
},{"../lang/isNative":34}],25:[function(require,module,exports){
...
},{"./getLength":23,"./isLength":28}],26:[function(require,module,exports){
...
},{"../lang/isObject":35,"./isArrayLike":25,"./isIndex":26}],28:[function(require,module,exports){
/**
 * Used as the [maximum length](http://ecma-international.org/ecma-262/6.0/#sec-number.max_safe_integer)
 * of an array-like value.
 */
...
},{"../lang/isArguments":31,"../lang/isArray":32,"../object/keysIn":40,"./isIndex":26,"./isLength":28}],31:[function(require,module,exports){
...
},{"../internal/isArrayLike":25,"../internal/isObjectLike":29}],32:[function(require,module,exports){
...
},{"../internal/getNative":24,"../internal/isLength":28,"../internal/isObjectLike":29}],33:[function(require,module,exports){
...
},{"../internal/isObjectLike":29,"./isFunction":33}],35:[function(require,module,exports){
/**
...
},{"../internal/arrayCopy":13,"../internal/getLength":23,"../internal/isLength":28,"../object/values":41}],37:[function(require,module,exports){
...
},{"../internal/assignWith":15,"../internal/baseAssign":16,"../internal/createAssigner":21}],38:[function(require,module,exports){
...
},{"../internal/assignDefaults":14,"../internal/createDefaults":22,"./assign":37}],39:[function(require,module,exports){
var getNative = require('../internal/getNative'),
...
},{"../internal/getNative":24,"../internal/isArrayLike":25,"../internal/shimKeys":30,"../lang/isObject":35}],40:[function(require,module,exports){
var isArguments = require('../lang/isArguments'),
    isArray = require('../lang/isArray'),
...
},{"../internal/isIndex":26,"../internal/isLength":28,"../lang/isArguments":31,"../lang/isArray":32,"../lang/isObject":35}],41:[function(require,module,exports){
...
},{"../internal/baseValues":19,"./keys":39}],42:[function(require,module,exports){
/**
...
var _viewsPosts = require('./views/Posts');

var _viewsPosts2 = _interopRequireDefault(_viewsPosts);

var _viewsToasts = require('./views/Toasts');

var _viewsToasts2 = _interopRequireDefault(_viewsToasts);
...
function IndexController(container) {
  ...
  this._postsView = new _viewsPosts2['default'](this._container);
  this._toastsView = new _viewsToasts2['default'](this._container);
...
},{"./views/Posts":47,"./views/Toasts":48,"idb":11}],46:[function(require,module,exports){
'use strict';
...
},{"../utils/loadScripts":50,"./IndexController":45}],47:[function(require,module,exports){
'use strict';
...
var _templatesPostHbs = require('./../../../../templates/post.hbs');

var _templatesPostHbs2 = _interopRequireDefault(_templatesPostHbs);
...
var _utilsHumanReadableTimeDiff = require('./../../utils/humanReadableTimeDiff');

var _utilsHumanReadableTimeDiff2 = _interopRequireDefault(_utilsHumanReadableTimeDiff);

var maxMessages = 30;

function Posts(container) {
  var posts = this;
...
Posts.prototype._timesUpdate = function () {
  var postTimeEls = (0, _lodashLangToArray2['default'])(this._container.querySelectorAll('.post-time'));
  postTimeEls.forEach(function (timeEl) {
    var postDate = new Date(timeEl.getAttribute('datetime'));
    timeEl.textContent = (0, _utilsHumanReadableTimeDiff2['default'])(postDate);
  });
...
Posts.prototype.addPosts = function (messages) {
  ...
  var htmlString = messages.map(function (message) {
    return (0, _templatesPostHbs2['default'])(message);
  }).join('');

  // add to the dom
  var nodes = (0, _utilsParseHTML2['default'])(htmlString);
  this._scroller.insertBefore(nodes, this._scroller.firstChild);

  // remove really old posts to avoid too much content
  var posts = (0, _lodashLangToArray2['default'])(this._scroller.querySelectorAll('.post'));
...
},{"./../../../../templates/post.hbs":52,"./../../utils/humanReadableTimeDiff":49,"./../../utils/parseHTML":51,"lodash/lang/toArray":36}],48:[function(require,module,exports){
'use strict';
...
var _templatesToastHbs = require('./../../../../templates/toast.hbs');

var _templatesToastHbs2 = _interopRequireDefault(_templatesToastHbs);
...
function Toast(text, duration, buttons) {
  ...
  this.container = (0, _utilsParseHTML2['default'])((0, _templatesToastHbs2['default'])({
    text: text,
    buttons: buttons
  })).firstChild;
  ...
  this.container.addEventListener('click', function (event) {
    var button = (0, _closest2['default'])(event.target, 'button', true);
    if (!button) return;
...
Toast.prototype.hide = function () {
  ...
  (0, _simpleTransition2['default'])(this.container, {
    opacity: 0
...
function Toasts(appendToEl) {
  this._container = (0, _utilsParseHTML2['default'])('<div class="toasts"></div>').firstChild;
...
Toasts.prototype.show = function (message, opts) {
  opts = (0, _lodashObjectDefaults2['default'])({}, opts, {
    duration: 0,
    buttons: ['dismiss']
  });
  ...
  (0, _simpleTransition2['default'])(toast.container, {
    opacity: 1
  }, 0.5, 'ease-out');
...
},{"./../../../../templates/toast.hbs":53,"./../../utils/parseHTML":51,"closest":1,"lodash/object/defaults":38,"simple-transition":44}],49:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, '__esModule', {
  value: true
});
exports['default'] = humanReadableTimeDiff;
...
function loadScripts(urls, yeyCallback, neyCallback) {
